...
import { ILand } from '../types/models.js';
...
const landSchema = new Schema<ILand>(
  {
    ...
    areaUnit: {
      type: String,
      enum: ['sqft', 'sqm', 'acre', 'hectare', 'katha', 'bigha', 'decimal'],
      default: 'sqft',
    },
    ...
    status: {
      type: String,
      enum: ['for_sale', 'for_lease', 'sold', 'leased', 'off_market'],
      default: 'for_sale',
    },
